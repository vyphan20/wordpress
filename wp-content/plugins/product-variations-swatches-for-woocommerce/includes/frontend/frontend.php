...
class VI_WOO_PRODUCT_VARIATIONS_SWATCHES_Frontend_Frontend {
	...
	public function variation_attribute_options_html( $html, $args ) {
		...
		$new_html .= 'data-display_type="'.$display_type_class.'" data-show_selected_item="'.$attribute_attr_selected.'" data-wpvs_attribute_name="attribute_' . esc_attr( sanitize_title( $attribute ) ) . '" ';
		$new_html .= '>';
